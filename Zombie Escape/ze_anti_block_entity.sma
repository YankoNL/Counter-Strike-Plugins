...
public plugin_init()
{
	register_plugin("[ZE] Anti-Block Map Entities", PLUGIN_VERSION, "YankoNL")
	register_cvar("ynl_ze_no_block_escape", PLUGIN_VERSION, FCVAR_SERVER|FCVAR_UNLOGGED|FCVAR_SPONLY);
